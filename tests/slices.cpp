...
TEST_CASE("Slices", "[slices]") {
  SECTION("SlicesDetectOneSimpleObject"){
    // Arrange
  ...
  SECTION("SlicesDetectTwoSimpleObjects"){
    // Arrange
    auto slices = od::Slices{math2d::Point{0, 0}};

    // construct first line
    auto slice = od::AnnotatedSlice{od::Slice{math2d::Point{0, 0}, math2d::Point{10, 0}}, 0};
    auto neighbour_slice = od::AnnotatedSlice{od::Slice{math2d::Point{21, 0}, math2d::Point{30, 0}}, 0};
  ...
  SECTION("SlicesDetectswoObjectOnTwoDifferentLines"){
    // Arrange
    auto slices = od::Slices{math2d::Point{0, 0}};
    ...
    auto second_slice_line = od::SliceLine{std::vector<od::AnnotatedSlice>{second_slice, second_neighbour_slice}, 1};
    slices.slices.push_back(second_slice_line);
  ...
  SECTION("SlicesDetectsOneObjectDiagonallyDown"){
    // Arrange
    auto slices = od::Slices{math2d::Point{0, 0}};
    ...
    // construct second line
    auto second_slice = od::AnnotatedSlice{od::Slice{math2d::Point{11, 1}, math2d::Point{20, 1}}, 1};
    auto second_slice_line = od::SliceLine{std::vector<od::AnnotatedSlice>{second_slice}, 1};
    slices.slices.push_back(second_slice_line);
  ...
  SECTION("SlicesDetectsOneObjectDiagonallyUp"){
    ...
    // construct first line
    auto slice = od::AnnotatedSlice{od::Slice{math2d::Point{11, 0}, math2d::Point{20, 0}}, 0};
    auto slice_line = od::SliceLine{std::vector<od::AnnotatedSlice>{slice}, 0};
    slices.slices.push_back(slice_line);
