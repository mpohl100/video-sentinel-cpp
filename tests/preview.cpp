...
TEST_CASE("Preview", "[preview]") {
  ...
  SECTION("PreviewProcessesFrameAfterPreviousFrameIsDone") {
    ...
    for (size_t i = 0; i < 100; i++) {
      ...
      std::cout << "Frame status: "
                << preview::to_string(frame_calculation_status) << std::endl;
  ...
  SECTION("SingleObjectPreviewProcessesFrameAfterPreviousFrameIsDone") {
    const auto path = std::string(CMAKE_SRC_DIR) + "/video/BillardTakeoff.mp4";
    ...
    const auto circle_ascii_art = std::string("   XXX   \n"
                                              " XXXXXXX \n"
                                              "XXXXXXXXX\n"
                                              "XXXXOXXXX\n"
                                              "XXXXXXXXX\n"
