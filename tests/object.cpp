...
TEST_CASE("Object", "[object]") {
  ...
  SECTION("ObjectsPerRectangleMergingRight"){
    const auto rectangle_left = od::Rectangle{math2d::Point{0, 0}, math2d::Point{10, 10}};
    auto objects_per_rectangle_left = od::ObjectsPerRectangle{};
    objects_per_rectangle_left.set_rectangle(rectangle_left);

    auto inside_object_left = std::make_shared<od::Object>(get_test_slices(math2d::Point{1, 1}, math2d::Point{2, 2}));
    auto touching_object_right = std::make_shared<od::Object>(get_test_slices(math2d::Point{4, 1}, math2d::Point{9, 4}));
    ...
    const auto rectangle_right = od::Rectangle{math2d::Point{10, 0}, math2d::Point{20, 10}};
    auto objects_per_rectangle_right = od::ObjectsPerRectangle{};
    objects_per_rectangle_right.set_rectangle(rectangle_right);

    auto inside_object_right = std::make_shared<od::Object>(get_test_slices(math2d::Point{15, 1}, math2d::Point{16, 2}));
    auto touching_object_left = std::make_shared<od::Object>(get_test_slices(math2d::Point{10, 1}, math2d::Point{14, 4}));
    ...
    CHECK(objects_per_rectangle_left.get_rectangle().to_math2d_rectangle() == od::Rectangle{math2d::Point{0, 0}, math2d::Point{20, 10}}.to_math2d_rectangle());
    ...
    auto inside_object_right = std::make_shared<od::Object>(get_test_slices(math2d::Point{15, 1}, math2d::Point{16, 2}));
    auto touching_object_left_candidate = std::make_shared<od::Object>(get_test_slices(math2d::Point{11, 1}, math2d::Point{14, 4}));
    objects_per_rectangle_right.insert_object(inside_object_right);
    ...
    auto inside_object_left = std::make_shared<od::Object>(get_test_slices(math2d::Point{1, 1}, math2d::Point{2, 2}));
    auto touching_object_right_candidate = std::make_shared<od::Object>(get_test_slices(math2d::Point{4, 1}, math2d::Point{8, 4}));
    objects_per_rectangle_left.insert_object(inside_object_left);
  ...
  SECTION("ObjectsPerRectangleAppendDown"){
    ...
    auto inside_object = std::make_shared<od::Object>(get_test_slices(math2d::Point{1, 1}, math2d::Point{2, 2}));
    auto touching_object_down_candidate = std::make_shared<od::Object>(get_test_slices(math2d::Point{4, 4}, math2d::Point{8, 8}));
    objects_per_rectangle_up.insert_object(inside_object);
    ...
    auto inside_object_down = std::make_shared<od::Object>(get_test_slices(math2d::Point{1, 15}, math2d::Point{2, 16}));
    auto touching_object_up_candidate = std::make_shared<od::Object>(get_test_slices(math2d::Point{4, 11}, math2d::Point{8, 14}));
    objects_per_rectangle_down.insert_object(inside_object_down);
  ...
  SECTION("ObjectsPerRectangleMergeDownMergesTwoAdjacentObjectsToTheBottom"){
    const auto rectangle_up = od::Rectangle{math2d::Point{0, 0}, math2d::Point{100, 100}};
    auto objects_per_rectangle_up = od::ObjectsPerRectangle{};
    objects_per_rectangle_up.set_rectangle(rectangle_up);
    ...
    const auto rectangle_down = od::Rectangle{math2d::Point{0, 100}, math2d::Point{100, 200}};
    auto objects_per_rectangle_down = od::ObjectsPerRectangle{};
    objects_per_rectangle_down.set_rectangle(rectangle_down);

    auto touching_object_up = std::make_shared<od::Object>(get_test_slices(math2d::Point{1, 100}, math2d::Point{49, 150}));
    objects_per_rectangle_down.insert_object(touching_object_up);

    auto touching_object_up_2 = std::make_shared<od::Object>(get_test_slices(math2d::Point{51, 100}, math2d::Point{98, 150}));
