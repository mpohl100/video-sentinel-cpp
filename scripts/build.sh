...
conan install .. --build="missing" --output-folder=conan_output -pr:a="$(pwd)/../conan_profiles/gcc11_cpp20.prof" --update -c tools.system.package_manager:mode=install -c tools.system.package_manager:sudo=True 
